/* @ts-self-types="./perspektive_wasm.d.ts" */
 ...
 * @returns {any}
 */
export function calculate_geodesic(p1, p2) {
    const ret = wasm.calculate_geodesic(p1, p2);
    if (ret[2]) {
 ...
 * @returns {number}
 */
export function conformal_factor(p) {
    const ret = wasm.conformal_factor(p);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return ret[0];
 ...
 * @returns {number}
 */
export function poincare_distance(p1, p2) {
    const ret = wasm.poincare_distance(p1, p2);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return ret[0];
 ...
 * @returns {any}
 */
export function stereographic_project(p) {
    const ret = wasm.stereographic_project(p);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./perspektive_wasm_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('perspektive_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
